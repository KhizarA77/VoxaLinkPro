...
def transcribe_audio(audio_file, model, processor):
    ...
    # Decide on the number of chunks based on the file length (e.g., for every 30 minutes of audio, process in 1-minute chunks)
    chunk_length_minutes = max(1, audio_length_seconds / 1800)

    # Convert chunk_length_minutes to max_seconds
