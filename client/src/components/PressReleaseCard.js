...
const PressReleaseCard = ({ data }) => {
  ...
  return (
    <ScrollContainer
      ...
      className="scrollbar-thin flex space-x-4 overflow-auto py-4 px-6"
    >
      {data.map((item, index) => (
        <motion.div
          key={index}
        ...
        >
          <div className="md:w-80 md:h-96 w-60 h-[20rem] md:pb-0 pb-16 bg-[#26272C] rounded-lg shadow-md overflow-hidden">
            {" "}
