  ...
  return (
    ...
    <div className="md:w-[40%] w-full">
        ...
        <p className="text-white text-[1rem] lg:text-[1rem] font-light lg:text-left text-center mt-4">
            Transcending Verbal Limits: Navigating Real-World Constraints by Interweaving Blockchain Technology With Speech AI
        </p>
        ...
        <div className="mt-4 flex flex-col items-center lg:items-start">
          ...
          <a href="https://docsend.com/view/udmsw2jatjwwzxfa" className="mb-4 inline-block bg-purple-600 text-white py-2 px-4 rounded-lg hover:bg-purple-700 transition duration-300" target="_blank" rel="noopener noreferrer">
            Whitepaper
          </a>
          {/* Larger social icons with hover effect */}
          <div className="flex items-center space-x-4">
            <a href={twitterLink} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition transform duration-300">
              <Image src="/Icons/x.svg" alt="Twitter" width={30} height={30} />
            </a>
            <a href={telegramLink} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition transform duration-300">
              <Image src="/Icons/telegram.svg" alt="Telegram" width={30} height={30} />
            </a>
            <a href={discordLink} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition transform duration-300">
      ...
      <div className="p-8 md:p-20 rounded-2xl bg-[#333] bg-opacity-10 backdrop-blur-md flex flex-col justify-center items-center z-10 shadow-lg w-full max-w-6xl mx-auto relative overflow-hidden">
        ...
        <p className="text-gray-300 relative">
          VoxaLink Pro is an ERC-20 token deployed on Ethereum mainnet. The total supply of $VXLP tokens is 1 billion (1,000,000,000).
        </p>
      ...
      <div className="mt-[13rem] mb-[10rem] mx-4">
        <div className="flex flex-col items-center justify-center">
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button
              className={`bttn flex-shrink-0 px-6 py-2 text-white border border-purple-600 ${
                selectedTable === "allocation" ? "bg-purple-600" : "bg-transparent"
              } rounded-full mx-2 transition-all duration-500 ease-in-out relative overflow-hidden shadow-lg`}
      ...
      <div className="relative mt-[10rem] pb-[15rem] pt-[5rem] md:py-[15rem] flex justify-center items-center w-full">
